...
public interface AlbumMapper {
    ...
    @Insert("INSERT INTO albums (title, artist_int, release_date, tani) VALUES (#{title}, #{artistInt}, #{releaseDate}, #{tani})")
    ...
    @Update("UPDATE albums SET title = #{title}, artist_int = #{artistInt}, release_date = #{releaseDate}, tani = #{tani} WHERE album_id = #{albumId}")
